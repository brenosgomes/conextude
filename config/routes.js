module.exports = (app) => {
    ...
    app.route("/student/unit/:id")
      .get(app.api.student.unit.getById);
  ...
  app.route("/student/bulletin/:id").get(app.api.student.bulletin.getById);
  ...
  //teacher
  app.route("/teacher/clas/:id").get(app.api.teacher.clas.getById);

  app.route("/teacher/classroom/:id").get(app.api.teacher.classroom.getById);

  app
    .route("/teacher/bulletin")
